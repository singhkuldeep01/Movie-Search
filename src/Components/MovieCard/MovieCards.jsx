...
function MovieCards({ searchInput, cardClickHandler }) {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`https://www.omdbapi.com/?s=${encodeURIComponent(searchInput)}&page=${currentPage}&apikey=a11863ac`);
